...
export default function Promotion() {
    ...
    const getProduct = async () => {
        const res = await axiosClient.get('promotion/detail/' + promotionId);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            // console.log(values);
            try {
                await axiosClient.put('promotion/' + promotionId, {
                    title: title,
                    code: code,
                    value: value,
                    startDate: startDate,
    ...
    return (
        <div className={cx('new-product')}>
            <h1 className={cx('add-product-title')}>Cập nhật khuyến mãi</h1>
