...
import { Card, Col, Divider, Modal, Row, Steps, Table } from 'antd';
...
const OrderHistoryPage = () => {
    ...
    const handleOrderCancel = async () => {
        // const res = await postOrderCancel(order.id);
                            ...
                            <div className={cx('body__info')}>
                                <div className={cx('body__info-header')}>
                                    ...
                                    <div className={cx('body__info-header-btn')}>
                                        <Button>Liên hệ cửa hàng</Button>
                                        {order?.status !== 'CANCEL' &&
                                            order?.status !== 'COMPLETE' &&
                                            cancel === false && (
                                                <Button onclick={() => setModalOpen(true)}>Hủy đơn</Button>
                                            )}
                                    </div>
                                </div>
                                    ...
                                    <Row>
                                        <Col span={10} style={{ padding: '0 0.5rem' }}>
                                            <div className={cx('body__info-body-address')}>
                                                ...
                                                <div className={cx('body__info-body-address-title')}>Số điện thoại</div>
                                                <div className={cx('body__info-body-address-text')}>
                                            ...
                                            <div className={cx('body__info-body-process')}>
                                                {cancel || order?.status === 'CANCEL' || (
                                                    <div className={cx('body__info-body-process-title')}>
                                                        Dự kiến nhận hàng vào ngày&nbsp;
                                                        {moment(order.leadtime).format('mm:hh, DD/MM/YYYY')}
                                                    </div>
                                                )}
                                                            ...
                                                            cancel || order?.status === 'CANCEL'
                                                                ...
                                                                : [
                                                                      ...
                                                                      },
                                                                      {
                                                                          ...
                                                                          description: step === 2 && (
                                                                              <span>
                                                                                  {moment(order.deliveringDate).format(
                                                                                      'mm:hh, DD/MM/YYYY'
                                                                                  )}
                                                                              </span>
                                                                          ),
                                                                      },
                                                                      {
                                                                          ...
                                                                          description: step === 3 && (
                                                                              <span>
                                                                                  {moment(order.completeDate).format(
                                                                                      'mm:hh, DD/MM/YYYY'
                                                                                  )}
                                                                              </span>
                                                                          ),
                                ...
                                <div className={cx('body__info')}>
                                    ...
                                    >
                                        <div className={cx('body-cart-item')}>
                                            <div className={cx('body-cart-item-title')}>Tổng tiền hàng</div>
                                            <div className={cx('body-cart-item-price')}>
                                                {NumberWithCommas(order.finalPrice)}&nbsp;₫
                                            </div>
                                        </div>
                                        <div className={cx('body-cart-item')}>
                                            <div className={cx('body-cart-item-title')}>Tiền giảm giá</div>
                                            <div className={cx('body-cart-item-price')} style={{ color: '#47991f' }}>
                                                - {NumberWithCommas(order.discountPrice)}&nbsp;₫
                                            </div>
                                        </div>
                                        <div className={cx('body-cart-item')}>
                                            <div className={cx('body-cart-item-title')}>Chi phí vận chuyển</div>
                                            <div className={cx('body-cart-item-price')}>
                                                {NumberWithCommas(order.shipPrice)}&nbsp;₫
                                            </div>
                                        </div>
                                        <div className={cx('body-cart-item')}>
                                            <div className={cx('body-cart-item-title')}>Phương thức thanh toán</div>
                                            <div className={cx('body-cart-item-price')}>
                                        ...
                                        <Divider />
                                        <div className={cx('body-cart-item')}>
                                            <div className={cx('body-cart-item-total')}>Tổng thanh toán</div>
